error id: file:///E:/2eme/javafx/Gestion_de_bibliothéque/src/Controller/SignInController.java:javafx/fxml/Initializable#
file:///E:/2eme/javafx/Gestion_de_bibliothéque/src/Controller/SignInController.java
empty definition using pc, found symbol in pc: javafx/fxml/Initializable#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 389
uri: file:///E:/2eme/javafx/Gestion_de_bibliothéque/src/Controller/SignInController.java
text:
```scala
package Controller;
...
import javafx.fxml.Initiali@@zable;
